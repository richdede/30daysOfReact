...
[![Instagram Follow](https://img.shields.io/badge/Instagram-Follow-ff69b4?style=social&logo=instagram)](https://www.instagram.com/iamt_toby/)
  ...
  <h2 align="center">30 Days Of React: React Router</h2>
...
```js
prince@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-days-of-react$ npm install react-router-dom
```
...
const challenges = [
  {
    ...
    slug: 'pyhton',
    url:
      'https://github.com/https://https://github.com/prince/30-Days-Of-Python.com/prince/30-Days-Of-JavaScript/30-Days-Of-React',
    author: {
      firstName: 'prince',
      lastName: 'Dee',
    },
  },
  {
    ...
    slug: 'javascript',
    url: 'https://github.com/prince/30-Days-Of-JavaScript',
    author: {
      firstName: 'prince',
      lastName: 'Dee',
    },
  },
  {
    ...
    slug: 'react',
    url: 'https://github.com/prince/30-Days-Of-React',
    author: {
      firstName: 'prince',
      lastName: 'Dee',
    },
