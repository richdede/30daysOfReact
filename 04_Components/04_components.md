...
[![Instagram Follow](https://img.shields.io/badge/Instagram-Follow-ff69b4?style=social&logo=instagram)](https://www.instagram.com/iamt_toby/)
  ...
  <h2 align="center">30 Days Of React: Components </h2>
...
![Site Desktop Demo](./assets/thumbnail.png "Desktop Demo")
...
console.log(
  getUserInfo("Dee", "Prince", "Nigeria", "FullStack Developer", skills)
);
```
...
const p1 = new Parent("Dee", "Prince", "Nigeria", "FullStack Developer");
...
![user Desktop Demo](./assets/user.png "Desktop Demo")
