...
[![Instagram Follow](https://img.shields.io/badge/Instagram-Follow-ff69b4?style=social&logo=instagram)](https://www.instagram.com/iamt_toby/)
  ...
  <h2 align="center">30 Days Of React: Props</h2>
...
![Site Desktop Demo](./thumbnail.jpg "Desktop Demo")
...
getUserInfo('Dee', 'Prince', 'Finland')
...
<User firstName = 'Dee', lastName='Prince' country = 'Finland' />
```
...
// Function to display time in Mon date, year format eg Mar 20, 2024
const showDate = (time) => {
  const months = [
    'January',
    'February',
